<?php
	...
	*/
	...
	(
		...
		2 => "The system was unable to connect to the database server at this time.<p/>
		This is usually the result of us being over capacity during peak load times.<p/>
		<b>What you can do:</b>
		<ul>
		<li>Wait 30 seconds and then click here to <a href='javascript:history.go(-1)'>refresh</a> and try again,
		<li>Call Umoya Support on +27 (0)21 702 4848 (weekdays 08h30 - 16h30), or</li>
		<li>Email support@umoya.net</li></ul><p/>
		...
		*/
		...
		function connect($dbuser='', $dbpassword='', $dbhost='localhost')
		{
			...
			else if ( ! $this->dbh = @mysql_connect($dbhost,$dbuser,$dbpassword,true) )
			{
				...
				$this->show_errors ? cs_bail($ezsql_mysql_str[2], "Cannot connect to database server") : null;
			}
			else
			{
				$this->dbuser = $dbuser;
